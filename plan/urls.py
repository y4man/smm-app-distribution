...
urlpatterns = [
    ...
    path('<int:pk>', views.PlanView.as_view(), name='plan-rud'),
    ...
    path('assigned-account-managers-list/<int:plan_id>', views.AssignedAccountManagerSearchView.as_view(), name='search-assigned-account-managers'),
