...
urlpatterns = [
    ...
    path('clients/<int:id>/', views.ClientCalendarListCreateView.as_view(), name='calendar-list-create'),
    ...
    path('get/<int:calendar_id>/dates', views.ClientCalendarDateListCreateView.as_view(), name='calendar-date-list-create'),

    # ✅ View a single date entry's details
    path('get/<int:calendar_id>/dates/<int:pk>', views.ClientCalendarDateRetrieveUpdateDeleteView.as_view(), name='calendar-date-rud'),
