...
urlpatterns = [
    ...
    path('notes', views.ListCreateNoteView.as_view(), name='list_create_note'), 

    # ✅ Detailed view of a single note
    path('notes/<int:pk>', views.RetrieveUpdateDeleteNoteView.as_view(), name='retrieve_update_delete_note'), 
